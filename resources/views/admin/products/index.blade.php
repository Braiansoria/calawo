...
@section('titulo', 'Administracion de poroductos')
        ...
        <table class="table table-head-fixed">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a class="btn btn-success" href="{{ route('admin.product.show',$producto->slug)}}">Ver</a></td>
              <td><a class="btn btn-info" href="{{ route('admin.product.edit',$producto->slug)}}">Editar</a></td>
