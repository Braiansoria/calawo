...
var apicategory = new Vue({
  ...
  computed: {
    generarSlug: function generarSlug() {
      ...
      return this.slug; //return  this.nombre.trim().replace(/ /,'-')toLowerCase()
    }
  },
  methods: {
...
module.exports = __webpack_require__(/*! C:\Users\coloritos2\Documents\Calawo\resources\js\app_admin.js */"./resources/js/app_admin.js");
